...
test('View an article created by another user', async ({
  ...
  await internalViewArticlePage.authorsArticleContentBlock.assertArticleTitleIsVisible(articleWithoutTags.title);
  await internalViewArticlePage.articleContentBlock.assertArticleTextIsVisible(articleWithoutTags.text);
  await internalViewArticlePage.articleContentBlock.assertArticleAuthorNameIsVisible(users[0].username);
});
